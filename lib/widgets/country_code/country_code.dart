...
class CountryCode {
  ...
  String toCountryCodeStringOnly() => code?.trim() ?? '';

  String? get _cleanName {
    return name?.replaceAll(RegExp(r'[[\]]'), '').split(',').first;
  }

  // String toCountryCodeStringOnly() => _cleanCountryCode ?? '';
  // String? get _cleanCountryCode {
  //   return code?.replaceAll(RegExp(r'[[\]]'), '').split(',').first.trim();
  // }
}
